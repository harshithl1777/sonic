    ...
    (
        ...
        const onDrop = useCallback(
            (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
                ...
                if (!files) {
                    toast({ title: 'File Error', description: 'File size exceeds limit.', variant: 'destructive' });
                    return;
                }
                ...
                if (rejectedFiles.length > 0) {
                    for (let i = 0; i < rejectedFiles.length; i++) {
                        if (rejectedFiles[i].errors[0]?.code === 'file-too-large') {
                            toast({
                                title: 'File Error',
                                description: 'File size exceeds limit. Max size is 25 MB.',
                                variant: 'destructive',
                            });
                            break;
                        }
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <RemoveIcon className='text-gray-400 w-4 h-4 hover:stroke-destructive duration-200 ease-in-out' />
                </button>
            </div>
        );
    },
