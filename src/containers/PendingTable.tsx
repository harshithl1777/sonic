...
import { ArrowUpDown, ChevronDown, Eye, PenIcon, RefreshCw, Search, TimerIcon, XCircle } from 'lucide-react';
...
interface PendingTableProps {
    ...
    updateEmailFn: Function;
    cancelEmailFn: Function;
...
export const PendingTable: React.FC<PendingTableProps> = ({
    ...
    const columns: ColumnDef<Contact>[] = [
        ...
        },
        {
            ...
            cell: (_) => (
                <div className='dark:text-slate-200'>
                    <Button
                        variant='ghost'
                        className='h-8 w-32 mr-4 bg-indigo-500 text-white dark:text-slate-900 hover:bg-indigo-500 hover:text-slate-900'
                    >
                        <TimerIcon />
                        Scheduled
                    </Button>
        ...
        },
        {
            ...
            cell: ({ row }) => <div className='dark:text-slate-400'>{row.getValue('sendAt')}</div>,
        },
        {
            accessorKey: 'labURL',
            header: ({ column }) => {
                        ...
                        <div className='flex flex-row gap-2'>
                            ...
                            <Tooltip>
                                <TooltipTrigger>
                                    <Button
                                        variant='ghost'
                                        className='h-8 w-8 bg-sky-500 text-white dark:text-slate-900 hover:bg-sky-400 hover:text-slate-900 font-semibold'
                                        onClick={() => updateEmailFn(row.original)}
                                    >
                                        <span className='sr-only'>Edit</span>
                                        <PenIcon strokeWidth={2.25} />
                                    </Button>
                                </TooltipTrigger>
                            ...
                            <Tooltip>
                                <TooltipTrigger>
                                    <Button
                                        variant='ghost'
                                        className='h-8 w-8 mr-4 bg-rose-500 text-white dark:text-slate-900 hover:bg-rose-400 hover:text-slate-900 font-semibold'
                                        onClick={() => cancelEmailFn(row.original)}
                                    >
